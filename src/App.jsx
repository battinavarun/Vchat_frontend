    ...
    <div className="App">
      ...
      <form className="App-form" onSubmit={submitHandler}>
        ...
        <input
          ...
          className="App-input"
        />
        <button className="App-button" type="submit" disabled={mutation.isPending}>
          {mutation.isPending ? "Generating..." : "Generate Content"}
        </button>
        <section className="App-response">
          {mutation.isPending && (
            <div className="loading-message">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="animate-spin mr-2">
                <path opacity="0.2" d="M12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2Z" fill="currentColor"/>
              ...
              <div className="content-container" ref={contentRef}>
                ...
                {mutation.data ? (
                  <div 
                    ...
                    dangerouslySetInnerHTML={{ __html: formatContent(mutation.data) }}
                  />
                ) : (
                  <div className="generated-content">No content generated yet.</div>
                )}
              </div>
            </>
          )}
